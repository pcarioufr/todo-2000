...
- **Work happens in simple source files** (`knowledge/initiatives/`, `knowledge/people/`, `knowledge/routines/`)
...
- **Balanced mix** of initiatives, people development, and routines
